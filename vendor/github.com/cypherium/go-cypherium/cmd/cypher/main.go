...
import (
	...
	"github.com/cypherium/go-cypherium/accounts/keystore"
	"github.com/cypherium/go-cypherium/cmd/utils"
	"github.com/cypherium/go-cypherium/console"
	"github.com/cypherium/go-cypherium/core/vm"
	"github.com/cypherium/go-cypherium/cphclient"
	"github.com/cypherium/go-cypherium/crypto/bls"
	"github.com/cypherium/go-cypherium/internal/debug"
	"github.com/cypherium/go-cypherium/log"
	"github.com/cypherium/go-cypherium/metrics"
	"github.com/cypherium/go-cypherium/node"

	onetLog "github.com/cypherium/go-cypherium/onet/log"
...
var (
	...
	app = utils.NewApp(gitCommit, "the go-cypherium command line interface")
...
func init() {
	...
	app.Copyright = "Copyright 2018 The go-cypherium Authors"
	...
	app.Before = func(ctx *cli.Context) error {
		log.Debug("onet debug level: ", ctx.Int("onetdebug"))

		onetLog.SetDebugVisible(ctx.Int("onetdebug"))
