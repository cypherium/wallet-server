...
import (
	...
	"github.com/cypherium/go-cypherium/onet"
...
func ParseCothority_cyher(hc *CothorityConfig) (*onet.Server, error) {
	...
	if hc.WebSocketTLSCertificate != "" && hc.WebSocketTLSCertificateKey != "" {
		...
		if err != nil {
			return nil, fmt.Errorf("getting WebSocketTLSCertificate content: %v", err)
		}
		tlsCertificateKey, err := hc.WebSocketTLSCertificateKey.Content()
		if err != nil {
			return nil, fmt.Errorf("getting WebSocketTLSCertificateKey content: %v", err)
		}
		cert, err := tls.X509KeyPair(tlsCertificate, tlsCertificateKey)
		if err != nil {
			return nil, fmt.Errorf("loading X509KeyPair: %v", err)
		}
...
type Group struct {
	Roster      *onet.Roster                       `json:"roster"`
	Description map[*network.ServerIdentity]string `json:"description"`
}
...
func ReadGroupDescTomlRecofig(group *GroupToml) (*Group, error) {

	//servier1 := &ServerToml{"tls://10.28.18.123:6879", "Ed25519", "9e3877e52b90bbfba0176aa10f7340bd4032573f3b1f6daf57e6c6b16045b2ec", "leader"}
	//servier2 := &ServerToml{"tls://10.28.18.123:7100", "Ed25519", "0ee01af829befd3660a36ef5823743dd7465e5bd1829495b1cf909271fccf3ea", "slave"}
	//servier1 := &ServerToml{"tls://192.168.1.103:6879", "Ed25519", "9e3877e52b90bbfba0176aa10f7340bd4032573f3b1f6daf57e6c6b16045b2ec", "leader"}
	//servier2 := &ServerToml{"tls://192.168.1.103:7100", "Ed25519", "0ee01af829befd3660a36ef5823743dd7465e5bd1829495b1cf909271fccf3ea", "slave"}
	//group := &GroupToml{}
	//group.Servers = append(group.Servers, servier1, servier2)
